export const profile = {
  name: "Samantha Cruz",
  shortName: "Samantha Cruz",
  role: "Ingeniera de Software",
  // Frases con efecto máquina de escribir en el Hero
  taglines: [
    "Software Engineer",
  ...
  // CV en public/cv/
  cvUrl: "/cv/Samantha-Cruz-CV.pdf",
  location: "México",
  email: "sch.samantha0504@gmail.com",
...
export const stats = [
  {
    ...
    value: 12,
    suffix: "+",
    detail: "De la idea al despliegue en producción",
    icon: "rocket",
  },
  {
    label: "Tecnologías",
    value: 21,
    suffix: "+",
    detail: "Un stack versátil en constante expansión",
    icon: "layers",
  },
  {
    ...
    value: 6,
    suffix: "+",
    detail: "Conocimiento validado y aplicado",
    icon: "award",
  },
  {
    label: "Canciones de Lana del rey por semana",
    value: 20,
    suffix: "+",
